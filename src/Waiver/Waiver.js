...
const Waiver = () => {
    ...
    if (!checkInitials()) {
        alert('Please ensure all initials are the same.');
        return; 
    }
...
//             const response = await axios.post('https://mfrbehiqnb.execute-api.us-west-1.amazonaws.com/dev/api/v2/uploadDocument', formData);
//             console.log("Upload response:", response.data);
//             window.location.reload();
//         } catch (error) {
//             console.error("Error creating PDF or uploading document:", error);
//         }
//     };
...
//       //const formString = JSON.stringify(formObject, null, 2); //formObject to JSON string
//         //const blob = new Blob([formString], { type: 'application/json' }); //Json to blob
...
//         // let formData = new FormData();
//         // formData.append('filename', blob, 'waiver.pdf'); //append blob as file
//         // formData.append('file-0', blob, 'waiver.txt');
